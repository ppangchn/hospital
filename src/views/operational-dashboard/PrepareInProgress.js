				...
				<div className="row">
					<div className="col-2 cell" style={{ bottom: '13px' }}>
						<div className="d-flex justify-content-center align-items-center cell flex-column">
							<div style={{ fontSize: '12px', marginBottom: '5px' }}>กำลังจัด[ใบ]</div>
							<Queue
								className="d-flex justify-content-center align-items-center"
								style={{ width: '80px', height: '40px' }}
							>
								{this.props.pick.length}
							</Queue>
						</div>
					</div>
					<div className="col-10 cell">
						...
						<div className="row ">
							...
							<div className="col-5">
								<div className="row d-flex justify-content-center align-items-center mr-1">
									<Queue1 className="d-flex justify-content-center align-items-center mr-1">
										{this.state.staff ? this.state.staff.full_pick : 0}
									</Queue1>
									<Queue1 className="d-flex justify-content-center align-items-center mr-1">
										{this.state.staff ? this.state.staff.part_pick : 0}
									</Queue1>
								</div>
							</div>
						</div>
